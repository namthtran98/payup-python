...
cookie1 = "partner=2; source=partner; referer=payup.video; _ga=GA1.1.922647611.1690460844; _ym_uid=1690460845789360581; _ym_d=1690460845; _ym_isad=1; signed=1; PHPSESSID=qdho2rna1b1iuas896gs9o6mde; _ga_SYT44ETTFS=GS1.1.1690460844.1.1.1690461140.0.0.0; hash=c50628728b01aeab09d8f6f2f9af219d; page=user; _ym_visorc=b"
apikey1 = "o8EPL80Zhhp0RX7eu4fcYkVxoL5nci42"
us = "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/114.0.0.0 Safari/537.36"
...
def giai_captcha(apikey, body, s_id, headers2):
    ...
    response5 = requests.post(
        'https://bux.money/captcha/control/check.php', headers=headers2, data=data_giai).json()
...
def payup_video(cookie, apikey, us):
    ...
    headers = {
        ...
        'referer': 'https://bux.money/tasks/video/',
    ...
    response = requests.post(
        'https://bux.money/tasks/control/get.php', headers=headers, data=data).text
    ...
    if int(data3['limitHour']) == 0 and int(data3['cnt']) <= 700:
        ...
        response99 = requests.post(
            'https://bux.money/tasks/control/start.php', headers=headers, data=data_job).json
        # print(response)
        ...
        response2 = requests.post(
            'https://bux.money/captcha/control/get.php', headers=headers2, data=data2)
        ...
        if response2.status_code == 200:
            ...
            if "ok" == co_captcha_khong:
                ...
                response3 = requests.post(
                    'https://bux.money/captcha/control/check.php', headers=headers, data=data)
