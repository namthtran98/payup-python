...
def SolveBuxMoneyCaptcha(us, apikey, cookie):
    headers = {
        ...
        'referer': 'https://bux.moneytasks/video/',
    ...
    if response2.status_code == 200:
        ...
        if "ok" == co_captcha_khong:
            print('dinh captcha')
            body = rs_load['data']
            g = giai_buxmoney_captcha(apikey=apikey, body=body,
            ...
            response3 = requests.post(
                'https://bux.money/control/check.php', headers=headers, data=data)
